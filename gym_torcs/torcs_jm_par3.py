...
# --------------------------
BASE_SPEED = 200  # straight-line target speed (km/h)
MIN_SPEED = 50  # minimum target speed in sharp turns
MAX_SPEED = 300  # cap speed (for safety / stability)
K_CURVE = 70  # how strongly curves reduce target speed (bigger = slower in turns)
