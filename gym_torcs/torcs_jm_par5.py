...
MIN_SPEED = 40  # minimum target speed in sharp turns
MAX_SPEED = 180  # cap speed (for safety / stability)
K_CURVE = 50  # how strongly curves reduce target speed (bigger = slower in turns)
