# This code was written by University of Exeter students participating in an IBM Hackathon
# It is available at https://github.com/bushh3/torcs_project/blob/master/gym_torcs/torcs_jm_par.py and used with permission of Jonny at IBM
...
STEER_GAIN = (
    40  # Steering sensitivity. Higher values make the car turn more aggressively.
)
CENTERING_GAIN = (
    0.40  # How strongly the car corrects its position toward the center of the track.
)
